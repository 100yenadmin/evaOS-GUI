...
: "${PYTHON_RUNTIME_VERSION:?PYTHON_RUNTIME_VERSION is required}"
: "${PYTHON_RUNTIME_RELEASE:?PYTHON_RUNTIME_RELEASE is required}"
: "${PYTHON_RUNTIME_ARM64_SHA256:?PYTHON_RUNTIME_ARM64_SHA256 is required}"
: "${PYTHON_RUNTIME_X64_SHA256:?PYTHON_RUNTIME_X64_SHA256 is required}"
