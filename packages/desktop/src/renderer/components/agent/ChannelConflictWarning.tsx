...
/**
 * Warning component when OpenClaw channel conflicts with evaOS channel routing.
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not evaOS Workbench.</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in evaOS Workbench will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use evaOS channel routing and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and evaOS Workbench.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for evaOS Workbench.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in evaOS channel routing and continue using OpenClaw's integration.
          </Paragraph>
