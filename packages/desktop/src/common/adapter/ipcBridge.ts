...
export const conversation = {
  ...
  stop: httpPost<{ runtime?: TConversationRuntimeSummary }, { conversation_id: string; turn_id?: string | null }>(
    (p) => `/api/conversations/${p.conversation_id}/cancel`,
    (p) => (p.turn_id ? { turn_id: p.turn_id } : {})
  ),
...
// ---------------------------------------------------------------------------
// evaOS bridge DTOs live in common/evaos to keep upstream bridge churn small.
// ---------------------------------------------------------------------------
