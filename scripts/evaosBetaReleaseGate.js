...
function inspectMacosZipBridgePayload(zipPath) {
  const script = [
    ...
    '        result["pythonLauncherValid"] = (stat.S_ISLNK(launcher_mode) and launcher_bytes == b"python3.12") or (stat.S_ISREG(launcher_mode) and bool(launcher_mode & 0o111) and macho_has_arch(launcher_bytes, expected_python_arch))',
