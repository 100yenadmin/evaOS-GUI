...
export const GOLDEN_WORKBENCH_PARITY_MANIFEST = [
  {
    ...
    statusRequirement: 'hidden-for-rc-default-landing-is-new-chat',
    proofTarget: {
      closeoutState: 'waived',
      planId: 'new-chat-landing',
  ...
  },
  {
    ...
    statusRequirement: 'hidden-for-rc-unless-admin-debug-policy-requires-it',
    proofTarget: {
      closeoutState: 'waived',
      planId: 'approvals',
  ...
  },
  {
    ...
    statusRequirement: 'read-only-mac-control-status-plus-workbench-connector-repair-handoff',
    proofTarget: {
