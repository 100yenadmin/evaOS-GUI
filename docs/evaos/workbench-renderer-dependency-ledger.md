...
rg -n "(from\\s+['\"](${MOVED_RENDERER_PACKAGE_PATTERN})(/[^'\"]*)?['\"]|import\\s+['\"](${MOVED_RENDERER_PACKAGE_PATTERN})(/[^'\"]*)?['\"]|import\\s*\\(\\s*['\"](${MOVED_RENDERER_PACKAGE_PATTERN})(/[^'\"]*)?['\"]\\s*\\)|require\\(\\s*['\"](${MOVED_RENDERER_PACKAGE_PATTERN})(/[^'\"]*)?['\"]\\s*\\))" \
