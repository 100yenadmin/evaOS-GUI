...
| #2 Upstream Sync + Fork Safety Baseline          | Open; baseline merged             |                     86% | Baseline is landed; upstream intake remains frozen unless security-critical while beta blockers are resolved.                                                                       |
| #3 evaOS Shell Guardrails                        | Open; guardrails merged           |                     90% | Team mode, remote-agent pairing, insecure remote-agent connections, and full-auto modes are fenced by default; final beta review still needs read-only legacy surface confirmation. |
...
| #11 Native Companion Boundary                    | Open; static boundary merged      |                     93% | Static boundary is strong; live native pairing/helper proof remains outside shell.                                                                                                  |
