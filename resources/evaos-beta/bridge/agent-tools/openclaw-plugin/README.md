...
plugin exposes no legacy pairing-code or connector-claim tool.

## Safety Notes

The plugin registers one exact gateway-authenticated release-canary route at
`POST /api/v1/evaos/mac-control/runtime-receipt`. Its public JSON body accepts
