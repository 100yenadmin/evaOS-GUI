...
describe('feedback logs', () => {
  ...
  it('collects recent logs from dated year/month/day directories and preserves redaction', () => {
    ...
    try {
      ...
      writeFileSync(path.join(recentDir, '2026-07-02.aioncore.log'), 'backend token=nested-secret-123456\n');
      ...
      expect(content).not.toContain('nested-secret-123456');
