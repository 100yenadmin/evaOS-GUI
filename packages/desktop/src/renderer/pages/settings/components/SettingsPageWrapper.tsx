...
import { isEvaosBetaSettingsTabVisible } from '@renderer/evaos/evaosBetaShellPolicy';
...
export function getBuiltinSettingsNavItems(isDesktop: boolean, t: TranslateFn): NavItem[] {
  ...
  return BUILTIN_TAB_IDS.filter(isEvaosBetaSettingsTabVisible).map((id) => builtinMap[id]);
}
