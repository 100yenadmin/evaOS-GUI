...
interface SiderDesignWorkspaceEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderDesignWorkspaceEntry: React.FC<SiderDesignWorkspaceEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
...
export default SiderDesignWorkspaceEntry;
