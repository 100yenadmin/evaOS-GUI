...
const SETTLED_SHELL_SCREENSHOT_PLAN = [
  ...
  },
  {
    ...
    target: 'Connected Apps native provider access',
    waitSelectors: [
      ...COMMON_WAIT_SELECTORS,
      'body:text("Connected Apps")',
      'body:text("Customer context")',
      'body:text("Provider access")',
    ],
    notes: ['Connected Apps renders as a native broker-scoped Workbench surface with fail-closed backend proof.'],
  },
  {
    id: 'people-access',
    route: '/people-access',
    screenshot: '15-people-and-access.png',
    target: 'People & Access native broker policy',
    waitSelectors: [
      ...COMMON_WAIT_SELECTORS,
      'body:text("People & Access")',
      'body:text("Customer context")',
      'body:text("Account access")',
    ],
    notes: ['People & Access renders as a native broker-scoped Workbench surface with fail-closed backend proof.'],
  },
  {
    id: 'company-brain',
    route: '/company-brain',
    screenshot: '16-company-brain.png',
    target: 'Company Brain native read-only account intelligence',
    waitSelectors: [
      ...COMMON_WAIT_SELECTORS,
      'body:text("Company Brain")',
      'body:text("Customer context")',
      'body:text("Company Brain directory")',
    ],
    notes: ['Company Brain renders as a native broker-scoped Workbench surface with fail-closed backend proof.'],
  },
];
