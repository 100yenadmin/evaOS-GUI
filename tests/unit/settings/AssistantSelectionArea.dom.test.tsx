...
describe('AssistantSelectionArea', () => {
  ...
  it('renders homepage assistant cards in evaOS release order with Cowork first', () => {
    render(
      <ConfigProvider>
        <AssistantSelectionArea
          ...
          assistants={[
            {
              ...
              description: 'Legacy setup helper',
            },
            {
              ...commonAssistant,
              id: 'builtin-moltbook',
              name: 'Moltbook',
              description: 'Retired catalog entry',
            },
            {
              ...commonAssistant,
              id: 'hermes-expert',
              name: 'Hermes Expert',
              description: 'Legacy upstream copy',
            },
          ]}
          localeKey='en-US'
          currentEffectiveAgentInfo={{
